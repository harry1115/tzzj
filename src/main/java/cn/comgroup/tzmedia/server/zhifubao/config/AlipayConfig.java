package cn.comgroup.tzmedia.server.zhifubao.config;
...
public class AlipayConfig {
	...
	// 调试用，创建TXT日志文件夹路径
	public static String log_path = "D:\\Comgroup\\alipaylog";
